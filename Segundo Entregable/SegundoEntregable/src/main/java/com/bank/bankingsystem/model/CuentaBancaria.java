...
public class CuentaBancaria {
    ...
    private int maxTransaccionesSinComision; // Numero maximo de transacciones sin comision
    private double comisionPorTransaccion; // Comision por transaccion adicional
